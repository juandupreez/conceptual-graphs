...
import { ExtractionOperation } from "../../main/operations/ExtractionOperation";
...
describe('Simple extraction', () => {
    ...
    it('Extract a new single relation', () => {
        ...
        const ifBoyBroOfGirlThenGirlSisOfBoyOperation: Operation = new ExtractionOperation(queryManager);
        ...
        // Apply Operation
        const extractedPhineasAndCandaceCG: ConceptualGraph = ifBoyBroOfGirlThenGirlSisOfBoyOperation.applyOperation(phineasAndCandaceCG);
    ...
    it('Extract a new single relation and concept', () => {
        ...
        const queryManager: ConceptualGraphQueryManager = new ConceptualGraphQueryManager(conceptTypeDao, relationTypeDao);
        const ifBoyBroOfGirlThenOtherBoyBroOfGirlOperation: Operation = new ExtractionOperation(queryManager);
        ...
        // Apply Operation
        const extractedPhineasAndCandaceCG: ConceptualGraph = ifBoyBroOfGirlThenOtherBoyBroOfGirlOperation.applyOperation(phineasAndCandaceCG);
    ...
    it('Extract several new concepts and relations', () => {
        ...
        const queryManager: ConceptualGraphQueryManager = new ConceptualGraphQueryManager(conceptTypeDao, relationTypeDao);
        const ifHumanIsFriendOfPhineasAndFerb: Operation = new ExtractionOperation(queryManager);
        ...
        // Apply Operation
        const extractedFriendsCG: ConceptualGraph = ifHumanIsFriendOfPhineasAndFerb.applyOperation(phineasFerbAndFriendsCG);
    ...
    it('Extracted graph should contain no nodes of the original graph unless they are in conclusion', () => {
        ...
        // Nodes which are in original but not in Operation's conclusion must not be in Extracted graph
    ...
    it('Concepts with the same Concept Types are identified via label', () => {
        ...
        // Create operation: if boy is brother of girl then ferb is brother of girl
        const queryManager: ConceptualGraphQueryManager = new ConceptualGraphQueryManager(conceptTypeDao, relationTypeDao);
        const ifHumanAIsFriendsWithHumanBAndC: Operation = new ExtractionOperation(queryManager);
        ...
        // Apply Operation
        const extractedBaljeetCG: ConceptualGraph = ifHumanAIsFriendsWithHumanBAndC.applyOperation(phineasAndCandaceCG);
    ...
    it('Must create a copy and not adjust the original', () => {
        ...
        // Apply Operation
        const extractedPhineasAndCandaceCG: ConceptualGraph = ifBoyBroOfGirlThenOtherBoyBroOfGirlOperation.applyOperation(originalPhineasAndCandaceCG);
    ...
    it('When no matches for hypothesis, return a an empty conceptual graph', () => {
        ...
        // Apply Operation
        const extractedJerryIsBrownCG: ConceptualGraph = ifBoyBroOfGirlThenOtherBoyBroOfGirlOperation.applyOperation(jerryIsBrownCG);
